...
DocumentQuery.prototype._defineGetters = function DocumentQuery_defineGetters() {
  var self       = this,
      properties = [
        'accept', 'accessKey', 'align', 'alt', 'autocomplete', 'autofocus',
        'baseURI', 'charset', 'checked', 'childElementCount', 'className',
        'clientHeight', 'clientLeft', 'clientTop', 'clientWidth',
        'contentEditable', 'coords', 'defaultChecked', 'defaultValue', 'dir',
        'disabled', 'download', 'draggable', 'formAction', 'formEnctype',
        'formMethod', 'formNoValidate', 'formTarget', 'hash', 'hidden', 'host',
        'hostname', 'href', 'hreflang', 'id', 'incremental', 'indeterminate',
        'innerHTML', 'innerText', 'isContentEditable', 'lang', 'length',
        'localName', 'max', 'maxLength', 'min', 'multiple', 'name',
        'namespaceURI', 'nodeName', 'nodeType', 'nodeValue', 'offsetHeight',
        'offsetLeft', 'offsetTop', 'offsetWidth', 'origin', 'outerHTML',
        'outerText', 'pathname', 'pattern', 'ping', 'placeholder', 'port',
        'prefix', 'protocol', 'readOnly', 'rel', 'required', 'rev',
        'scrollHeight', 'scrollLeft', 'scrollTop', 'scrollWidth', 'search',
        'selectedIndex', 'shape', 'size', 'spellcheck', 'src', 'step', 'style',
        'tabIndex', 'tagName', 'target', 'text', 'textContent', 'title',
        'type', 'useMap', 'validationMessage', 'value', 'valueAsDate',
        'valueAsNumber', 'willValidate'
      ];
