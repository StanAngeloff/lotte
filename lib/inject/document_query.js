...
DocumentQuery.prototype._bindProperties = function DocumentQuery_bindProperties() {
  var self = this;
  defaultProperties.forEach(function(property) {
    self.passthru(property);
  });
};

DocumentQuery.prototype.passthru = function DocumentQuery_passthru(property) {
  var self = this;
