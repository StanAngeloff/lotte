...
DocumentQuery.prototype._defineGetters = function DocumentQuery_defineGetters() {
  var self       = this,
      properties = [
        'accessKey', 'baseURI', 'charset', 'childElementCount', 'className',
        'clientHeight', 'clientLeft', 'clientTop', 'clientWidth',
        'contentEditable', 'coords', 'dir', 'download', 'draggable', 'hash',
        'hidden', 'host', 'hostname', 'href', 'hreflang', 'id', 'innerHTML',
        'innerText', 'isContentEditable', 'lang', 'length', 'localName',
        'name', 'namespaceURI', 'nodeName', 'nodeType', 'nodeValue',
        'offsetHeight', 'offsetLeft', 'offsetTop', 'offsetWidth', 'origin',
        'outerHTML', 'outerText', 'pathname', 'ping', 'port', 'prefix',
        'protocol', 'rel', 'rev', 'scrollHeight', 'scrollLeft', 'scrollTop',
        'scrollWidth', 'search', 'shape', 'spellcheck', 'style', 'tabIndex',
        'tagName', 'target', 'text', 'textContent', 'title', 'type'
      ];
